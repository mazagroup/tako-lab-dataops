...
public class RepositoryConnectControllerTest {
  ...
  public void testGetPlugins() throws Exception {
	...
	/*
	 * @Test public void testGetSetParentShell() { assertNull(
	 * controller.getParentShell() );
	 * 
	 * Shell mockShell = mock( Shell.class ); controller.setParentShell( mockShell
	 * ); assertNotNull( controller.getParentShell() ); assertEquals( mockShell,
	 * controller.getParentShell() ); }
	 */
