...
package org.tako.etl.pdi.repo.ws.timeout;
...
public class SessionTimeoutHandler {
  ...
  boolean showLoginScreen( RepositoryConnectController repositoryConnectController ) {
	  throw new UnsupportedOperationException("RepositoryConnectController.showLoginScreen()");
		/*
		 * String message = BaseMessages.getString( PKG,
		 * "Repository.Reconnection.Message" ); RepositoryDialog loginDialog = new
		 * RepositoryDialog( getSpoon().getShell(), repositoryConnectController );
		 * RepositoryMeta repositoryMeta =
		 * repositoryConnectController.getConnectedRepository(); return
