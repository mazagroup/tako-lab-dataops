...
package org.tako.etl.pdi.repo.ws.endpoints;

import org.json.simple.JSONObject;
import org.pentaho.di.core.exception.KettleAuthException;
import org.pentaho.di.i18n.BaseMessages;
import org.tako.etl.pdi.repo.ws.controller.RepositoryConnectController;
import org.tako.etl.pdi.repo.ws.model.BrowseModel;
import org.tako.etl.pdi.repo.ws.model.ErrorModel;
import org.tako.etl.pdi.repo.ws.model.LoginModel;
...
public class RepositoryEndpoint {
  ...
  @Consumes( { APPLICATION_JSON })
  @Produces( { APPLICATION_JSON } )
  public Response browse( BrowseModel model ) {
	  return Response.ok( controller.browse( model ) ).build();
  }
}
