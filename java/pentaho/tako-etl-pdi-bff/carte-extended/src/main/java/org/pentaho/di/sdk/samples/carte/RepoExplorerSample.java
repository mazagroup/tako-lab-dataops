...
import org.tako.etl.pdi.carte.plugins.RepositoryExplorerServlet;

public class RepoExplorerSample extends AbstractSample {
  ...
  public static void main( String[] args ) throws Exception {
    ...
    // building target url
    String urlString = getUrlString( args[ 0 ], args[ 1 ], args[ 2 ], args[ 3 ] );

    //building auth token
    String auth = getAuthString( args[ 2 ], args[ 3 ] );

    String response = sendGetRepoRootDirRequest( urlString, auth );
    if ( response != null ) {
  ...
  public static String sendGetRepoRootDirRequest( String urlString, String authentication ) throws Exception {
  ...
  public static String getUrlString( String realHostname, String port, String cmd, String params ) {
    String urlString = "http://" + realHostname + ":" + port + RepositoryExplorerServlet.CONTEXT_PATH+"/"+cmd
      + "?xml=Y"+params;
